...
import com.example.msauserapitest.config.scanner.requestmapping.RequestMappingInClass;
import com.example.msauserapitest.config.scanner.requestmapping.RequestMappingInMethod;
...
public class DefaultRequestPathScanner implements RequestPathScanner {
    ...
    private List<AnnotatedMethod> scanMethodsAnnotatedApiFor() {
        Reflections reflections = new Reflections(new ConfigurationBuilder()
                .forPackage("com.example.msauserapitest")
