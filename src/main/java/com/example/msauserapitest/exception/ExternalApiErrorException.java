...
public class ExternalApiErrorException extends InternalServerErrorException {
    ...
    public ExternalApiErrorException(final kr.co.gacha.exception.ExternalApiErrorMessage message) {
        super(String.format("%s -> %s", SERVER_MESSAGE, message.getDescription()), message.getDescription(), ERROR_CODE + message);
    }

    public ExternalApiErrorException(final kr.co.gacha.exception.ExternalApiErrorMessage message, final Throwable cause) {
        super(String.format("%s -> %s", SERVER_MESSAGE, message.getDescription()), message.getDescription(), ERROR_CODE + message, cause);
    }

    public ExternalApiErrorException(final kr.co.gacha.exception.ExternalApiErrorMessage message, String detailMessage) {
        super(String.format("%s -> %s(%s)", SERVER_MESSAGE, message.getDescription(), detailMessage), message.getDescription(), ERROR_CODE + message);
    }

    public ExternalApiErrorException(final kr.co.gacha.exception.ExternalApiErrorMessage message, String detailMessage, final Throwable cause) {
        super(
